...
- **No tested exit procedure:** contracts may include legal clauses, audits may exist, but operational execution—data migration, fallback procedures, disaster recovery—is ignored.
